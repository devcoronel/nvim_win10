...
var require_make_dir = __commonJS((exports, module2) => {
  ...
  var getMode = (options) => {
    ...
    if (typeof options === "number")
      return options;
    return __objSpread(__objSpread({}, defaults), options).mode;
  };
...
var require_remove = __commonJS((exports, module2) => {
  ...
  function remove(path11, callback) {
    if (fs7.rm)
      return fs7.rm(path11, {recursive: true, force: true}, callback);
    rimraf(path11, callback);
  }
  function removeSync(path11) {
    if (fs7.rmSync)
      return fs7.rmSync(path11, {recursive: true, force: true});
    rimraf.sync(path11);
  }
  module2.exports = {
    remove: u(remove),
